...
variable "subnet_prod_id" {
  description = "The ID of the subnet for the AKS node pool."
  type        = string
}

variable "keyvault_id" {
  description = "Key Vault ID (from phase1-core)"
  type        = string
  default     = null
}

variable "eventhub_namespace" {
  description = "EventHub namespace (from phase1-core)"
  type        = string
  default     = null
}

variable "vnet_id" {
  description = "Virtual Network ID from phase1-core output"
  type        = string
  default     = null
}
